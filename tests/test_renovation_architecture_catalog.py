...
(12/4/5/4/103 over 128 items) is pinned HERE, not in the builder, so a future
...
class TestShippedCatalogPins:
    ...
    def test_no_action_ids_are_the_approved_four(self, shipped_projection):
        no_action = {
            item_id
